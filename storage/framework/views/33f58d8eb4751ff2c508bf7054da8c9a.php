            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Data Warga Asli</h4>
                    </div>
                        ...
                        <div class="card-body">
                            <form class="form" data-parsley-validate>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            <label for="country-floating" class="form-label">Alamat</label>
                                    ...
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-end">
                                            <a href='<?php echo e(route('wargaAsli')); ?>' type="submit"
...
<?php echo $__env->make('layouts.default-ui', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rudeus\Laravel\pbl-project-sistem-kependudukan\resources\views/dataWarga/wargaAsli/update.blade.php ENDPATH**/ ?>