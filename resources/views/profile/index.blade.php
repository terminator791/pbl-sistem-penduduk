                                    ...
                                    <div class="col-md-12 col-12">
                                        ...
                                        <div>
                                            ...
                                            @if ($ketua_rt)
                                                @if ($ketua_rt->foto_ketua_rt)
                                                    <img style="width: 250px; height: 300px; text-align: center;" src="{{ asset('storage/' . $ketua_rt->foto_ketua_rt) }}" alt="Foto Ketua RT">
                                                @else
                                        ...
                                        <div>
                                            ...
                                            @if ($ketua_rw->foto_ketua_rw)
                                                <img style="width: 250px; height: 300px; text-align: center;" src="{{ asset('storage/' . $ketua_rw->foto_ketua_rw) }}" alt="Foto Ketua RT">
                                            @else
                                                <span>Tidak ada foto tersimpan.</span>
                                            @endif
                                        </div>
