            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" method="POST" action="{{ route('wargaPendatang.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            <label for="nama-kos" class="form-label"><strong>Nama Kos</strong></label>
                                            {{-- <input type="text" id="nama_kos" class="form-control"
                                                placeholder="Nama Kos" name="nama_kos" data-parsley-required="true" /> --}}
                                            <fieldset class="form-group">
                                                <select class="choices form-select" id="nama_kos" name="nama_kos">
                                                    <option disabled selected>Pilih Kos</option>
                                                    @foreach ($list_perkawinan as $perkawinan)
                                                        <option value="{{ $perkawinan->status_perkawinan }}">
                                                            {{ $perkawinan->status_perkawinan }}</option>
                                                        <!-- Use actual database values -->
