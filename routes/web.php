...
// Data Warga Asli
    Route::middleware(['check.level:admin,RT,RW'])->group(function () {
        Route::middleware(['check.level:admin,RT'])->group(function () {
    ...
    Route::middleware(['check.level:admin,RW'])->group(function (){
