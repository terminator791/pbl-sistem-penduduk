    ...
    public function index(Request $request)
{
    ...
    public function Create()
    {
        ...
        return view('dataWarga.wargaAsli.create', compact('list_pendidikan', 'list_pekerjaan', 
    ...
    public function edit($id)
{
    ...
    return view('dataWarga.wargaAsli.update', compact('penduduk', 'list_pendidikan', 'list_pekerjaan', 
                                         'list_perkawinan', 'list_RT', 
                                         'list_RW', 'list_keluarga'));
}
...
public function update(Request $request, $id)
{
    ...
    return redirect()->route('wargaAsli')->with('success', 'Penduduk updated successfully!');
}
    ...
    public function delete(Request $request, $id)
    {
        $penduduk = penduduk::findOrFail($id);
        $penduduk->delete();
        return redirect()->route('wargaAsli')->with('success', 'Penduduk Deleted successfully!');
    }
}
